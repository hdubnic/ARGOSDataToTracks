...
arcpy.AddField_management(outputFC,"FileName","TEXT")
...
for inputFile in os.listdir(inputFolder):
    ...
    while lineString:
        ...
        if ("Date :" in lineString):
            ...
            # Extract the file name for source of values
            obsFileName = os.path.basename(inputFile)
            ...
            try:
                ...
                cur.insertRow((obsPointGeom,tagID,obsLC,obsDate.replace(".","/") + " " + obsTime, obsFileName))
